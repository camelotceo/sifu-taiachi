            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-8">
                  <div>
                    <h1 className="text-5xl font-bold text-gray-800 mb-6">{content?.hero?.title || "Meet Dr. Danielle Beauvais"}</h1>
                    <p className="text-xl text-gray-600 leading-relaxed">
                      {content?.hero?.description || "Your compassionate guide to holistic wellness through the transformative power of Tai Chi, mindful movement, and integrated healing practices."}
                    </p>
                  </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="md:col-span-2 space-y-6">
                  <h2 className="text-3xl font-bold text-gray-800 mb-6">
                    {content?.biography?.title || "My Journey to Wellness"}
                  </h2>

                  <div className="prose prose-lg text-gray-600">
                    {content?.biography?.content ? (
                      content.biography.content.split('\n').filter((paragraph: any) => paragraph.trim()).map((paragraph: string, index: number) => (
                ...
                <div className="space-y-6">
                  <Card className="p-6 bg-gradient-to-br from-purple-100 to-pink-100">
                    <h3 className="font-bold text-gray-800 mb-4">Credentials & Training</h3>
                    <ul className="space-y-3 text-sm text-gray-600">
                      {content?.credentials?.map((credential: any, index: number) => (
                        <li key={credential.id || index} className="flex items-start gap-2">
                          <div className={`w-2 h-2 bg-${credential.color || ['purple', 'pink', 'orange', 'teal', 'indigo'][index % 5]}-500 rounded-full mt-2`} />
                          <span>{credential.title || credential}</span>
                        </li>
                      )) || (
                        <>
                  ...
                  <Card className="p-6 bg-gradient-to-br from-teal-100 to-blue-100">
                    <h3 className="font-bold text-gray-800 mb-4">Published Works</h3>
